...
fn main() {
    ...
    let cinfo = collect::collect_info_from_cpp_file("tests/test1/cpp.cc", None, None, &c_cx).unwrap();
    let rinfo = collect::collect_info_from_rust_file("tests/test1/rust.rs", &r_cx).unwrap();
