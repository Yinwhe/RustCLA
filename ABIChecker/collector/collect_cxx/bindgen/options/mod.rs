...
use crate::ir::{enum_ty::EnumVariation, var::MacroTypeVariation};
...
impl std::fmt::Display for AliasVariation {
...
impl std::fmt::Display for NonCopyUnionStyle {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
