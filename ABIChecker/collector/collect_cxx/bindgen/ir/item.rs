...
impl Item {
    ...
    pub fn set_parent_for_replacement<Id: Into<ItemId>>(
        &mut self,
        id: Id,
    ) {
    ...
    pub fn full_disambiguated_name(
        &self,
        ctx: &BindgenContext,
    ) -> String {
